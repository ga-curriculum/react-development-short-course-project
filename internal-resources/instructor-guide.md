...
You may also want to make changes to the planning materials students submit and the app they use to build them. For this project, students will build their planning materials using tktk by default. If you'd prefer something different, you'll need to create new Project Planning Deliverable documents.
